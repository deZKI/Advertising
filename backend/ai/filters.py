...
if __name__ == '__main__':
    point = {'lat': 55.742317,
             'lon': 37.608092}  # Example point
    # Обратите внимание что в shaply по другому задается долгота и широта - они поменены местами
    result = all_points_on_water_or_vegetation([point])
    print(result)
