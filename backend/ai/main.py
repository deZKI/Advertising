...
REQUIRED_COLUMNS = ['x : -inf - 55.55 | y : -inf - 37.3', 'x : -inf - 55.55 | y : 37.3 - 37.5',
                    'x : -inf - 55.55 | y : 37.5 - 37.699999999999996', 'x : -inf - 55.55 | y : 37.699999999999996 - 37.9',
                    'x : -inf - 55.55 | y : 37.9 - inf', 'x : 55.55 - 55.68333333333333 | y : -inf - 37.3',
                    'x : 55.55 - 55.68333333333333 | y : 37.3 - 37.5', 'x : 55.55 - 55.68333333333333 | y : 37.5 - 37.699999999999996',
                    'x : 55.55 - 55.68333333333333 | y : 37.699999999999996 - 37.9', 'x : 55.55 - 55.68333333333333 | y : 37.9 - inf',
                    'x : 55.68333333333333 - 55.81666666666667 | y : -inf - 37.3', 'x : 55.68333333333333 - 55.81666666666667 | y : 37.3 - 37.5',
                    'x : 55.68333333333333 - 55.81666666666667 | y : 37.5 - 37.699999999999996', 'x : 55.68333333333333 - 55.81666666666667 | y : 37.699999999999996 - 37.9',
                    'x : 55.68333333333333 - 55.81666666666667 | y : 37.9 - inf', 'x : 55.81666666666667 - 55.95 | y : -inf - 37.3',
                    'x : 55.81666666666667 - 55.95 | y : 37.3 - 37.5', 'x : 55.81666666666667 - 55.95 | y : 37.5 - 37.699999999999996',
                    'x : 55.81666666666667 - 55.95 | y : 37.699999999999996 - 37.9', 'x : 55.81666666666667 - 55.95 | y : 37.9 - inf',
                    'x : 55.95 - inf | y : -inf - 37.3', 'x : 55.95 - inf | y : 37.3 - 37.5', 'x : 55.95 - inf | y : 37.5 - 37.699999999999996',
                    'x : 55.95 - inf | y : 37.699999999999996 - 37.9', 'x : 55.95 - inf | y : 37.9 - inf', 'value', 'ageFrom', 'ageTo', 'income_abc',
                    'income_ac', 'income_bc', 'income_c', 'name_18-55', 'name_20-55 BC', 'name_30-99 C', 'name_35-100 C', 'name_ALL 18-54',
                    'name_ALL 18-55 BC', 'name_ALL 25-45 ', 'name_ALL 25-55 BC', 'name_ALL 30-50 AB', 'name_ALL 35-55 BC', 'name_ALL 35-55 C',
                    'name_All 13-25', 'name_All 14-49', 'name_All 15-25', 'name_All 18+', 'name_All 18+ C', 'name_All 18-100 BC', 'name_All 18-35 C',
                    'name_All 18-45', 'name_All 18-50 ', 'name_All 18-55 BC', 'name_All 20-40', 'name_All 20-40 BC', 'name_All 20-45 BC', 'name_All 20-55',
                    'name_All 20-55 C', 'name_All 25+ C', 'name_All 25-44 BC', 'name_All 25-45', 'name_All 25-45 AB', 'name_All 25-45 BC', 'name_All 25-50',
                    'name_All 25-50 BC', 'name_All 25-54 BC', 'name_All 25-55', 'name_All 25-55 BC', 'name_All 25-55 C', 'name_All 25-55 leroy_2021_04_remont',
                    'name_All 25-60', 'name_All 30-55 BC', 'name_All 30-55 C', 'name_All 35-45', 'name_All 35-54', 'name_All 35-55 C', 'name_All 35-70 BC',
                    'name_All 45-65 BC', 'name_M 18-35', 'name_M 25-54', 'name_M 25-55 ', 'name_M 25-55 BC', 'name_M 30-55 BC', 'name_M 35-55 BС  ',
                    'name_M 35-60', 'name_W 18+', 'name_W 18-25', 'name_W 18-45', 'name_W 18-45 BC', 'name_W 20-49 BC', 'name_W 25-45', 'name_W 25-45 BC',
                    'name_W 25-54', 'name_W 25-55 ', 'name_W 25-55 BC', 'name_W 30+ BC', 'name_W 30-55 BC', 'name_W 30-60', 'name_W 35+ BC', 'name_W 35-55 BC',
...
if __name__ == "__main__":
    df = pd.read_csv('train_data5.csv')  # Загрузите ваш DataFrame из файла
    result = main(df)
